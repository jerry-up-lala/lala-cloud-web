<template>
  ...
  >
    ...
    <template #content>
      ...
      >
        <icon-close />
        <span>{{ $t('tab.close.current') }}</span>
      </a-doption>
      <a-doption :disabled="disabledLeft" :value="Eaction.left">
        <icon-to-left />
        <span>{{ $t('tab.close.left') }}</span>
      </a-doption>
      <a-doption
        class="sperate-line"
      ...
      >
        <icon-to-right />
        <span>{{ $t('tab.close.right') }}</span>
      </a-doption>
      <a-doption :value="Eaction.others">
        <icon-swap />
        <span>{{ $t('tab.close.other') }}</span>
      </a-doption>
      <a-doption :value="Eaction.all">
        <icon-folder-delete />
        <span>{{ $t('tab.close.all') }}</span>
      </a-doption>
    </template>
  </a-dropdown>
</template>
